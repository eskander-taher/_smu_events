...
import useListSubmissionsByEvent from "../../api/submissions/useListSubmissionsByEvent";
...
const SubmissionListByEvent = () => {
	const { eventId } = useParams();
	const { data, isSuccess, isError, isLoading } = useListSubmissionsByEvent(eventId);
...
export default SubmissionListByEvent;
