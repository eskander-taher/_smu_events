		...
		<DefaultLayout>
			...
			<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
				<form className="pt-3 pb-3 pl-5 pr-5">
					...
					<div className="mb-4">
						<label className="mb-2.5 block font-medium text-black dark:text-white">
							Ученая степень, ученая звание научного руководителя
						</label>
						<div className="relative">
							<input
								type="text"
								...
								onChange={handleChange}
								placeholder="Введите ученую степень, ученое звание научного руководителя"
								className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
							/>
						</div>
					</div>
						...
						>
							<div className="w-full xl:w-1/3">
								<label className="mb-2.5 block text-black dark:text-white">
									ФИО соавтора {"(полностью)"}
								</label>
								<input
									type="text"
									placeholder="Введите ФИО соавтора"
